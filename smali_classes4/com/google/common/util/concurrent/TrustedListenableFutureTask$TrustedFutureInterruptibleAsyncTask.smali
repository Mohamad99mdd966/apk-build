...
# direct methods
.method public constructor <init>(Lcom/google/common/util/concurrent/TrustedListenableFutureTask;Lcom/google/common/util/concurrent/f;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 11
    .line 12
    iput-object p1, p0, Lcom/google/common/util/concurrent/TrustedListenableFutureTask$TrustedFutureInterruptibleAsyncTask;->callable:Lcom/google/common/util/concurrent/f;
...
.method public afterRanInterruptiblyFailure(Ljava/lang/Throwable;)V
    ...
    .line 2
    .line 3
    invoke-virtual {v0, p1}, Lcom/google/common/util/concurrent/AbstractFuture;->G(Ljava/lang/Throwable;)Z
...
.method public afterRanInterruptiblySuccess(Lcom/google/common/util/concurrent/z;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v0, p1}, Lcom/google/common/util/concurrent/AbstractFuture;->H(Lcom/google/common/util/concurrent/z;)Z
...
.method public bridge synthetic afterRanInterruptiblySuccess(Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1}, Lcom/google/common/util/concurrent/TrustedListenableFutureTask$TrustedFutureInterruptibleAsyncTask;->afterRanInterruptiblySuccess(Lcom/google/common/util/concurrent/z;)V
...
.method public final isDone()Z
    ...
    .line 2
    .line 3
    invoke-virtual {v0}, Lcom/google/common/util/concurrent/l$a;->isDone()Z
...
.method public runInterruptibly()Lcom/google/common/util/concurrent/z;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    .line 3
    invoke-interface {v0}, Lcom/google/common/util/concurrent/f;->call()Lcom/google/common/util/concurrent/z;

    move-result-object v0

    const-string v1, "AsyncCallable.call returned null instead of a Future. Did you mean to return immediateFuture(null)? %s"

    iget-object v2, p0, Lcom/google/common/util/concurrent/TrustedListenableFutureTask$TrustedFutureInterruptibleAsyncTask;->callable:Lcom/google/common/util/concurrent/f;
...
.method public bridge synthetic runInterruptibly()Ljava/lang/Object;
    ...
    .line 1
    invoke-virtual {p0}, Lcom/google/common/util/concurrent/TrustedListenableFutureTask$TrustedFutureInterruptibleAsyncTask;->runInterruptibly()Lcom/google/common/util/concurrent/z;
