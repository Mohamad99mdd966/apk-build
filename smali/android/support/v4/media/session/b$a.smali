...
.method public static b0(Landroid/os/IBinder;)Landroid/support/v4/media/session/b;
    .locals 2
...
.method public onTransact(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    .line 47
    .line 48
    invoke-interface {p0, p1, p2}, Landroid/support/v4/media/session/b;->D1(Landroid/support/v4/media/RatingCompat;Landroid/os/Bundle;)V
    ...
    .line 72
    invoke-interface {p0, p1}, Landroid/support/v4/media/session/b;->m(F)V
    ...
    .line 84
    invoke-interface {p0, p1}, Landroid/support/v4/media/session/b;->z(I)V
    ...
    .line 111
    :cond_2
    invoke-interface {p0, v0}, Landroid/support/v4/media/session/b;->q0(Z)V
    ...
    .line 150
    .line 151
    invoke-interface {p0, p1}, Landroid/support/v4/media/session/b;->U2(Landroid/support/v4/media/MediaDescriptionCompat;)V
    ...
    .line 171
    invoke-interface {p0, p1, p2}, Landroid/support/v4/media/session/b;->G1(Landroid/support/v4/media/MediaDescriptionCompat;I)V
    ...
    .line 186
    .line 187
    invoke-interface {p0, p1}, Landroid/support/v4/media/session/b;->W2(Landroid/support/v4/media/MediaDescriptionCompat;)V
    ...
    .line 202
    :cond_3
    invoke-interface {p0, v0}, Landroid/support/v4/media/session/b;->Z(Z)V
    ...
    .line 301
    .line 302
    invoke-interface {p0, p1, p2}, Landroid/support/v4/media/session/b;->M(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    .line 342
    :pswitch_15
    invoke-interface {p0}, Landroid/support/v4/media/session/b;->B()Ljava/lang/CharSequence;
    ...
    .line 427
    .line 428
    invoke-interface {p0, p1}, Landroid/support/v4/media/session/b;->M2(Landroid/support/v4/media/RatingCompat;)V
    ...
    .line 500
    invoke-interface {p0, p1, p2}, Landroid/support/v4/media/session/b;->Y(J)V
    ...
    .line 523
    .line 524
    invoke-interface {p0, p1, p2}, Landroid/support/v4/media/session/b;->Q(Landroid/net/Uri;Landroid/os/Bundle;)V
    ...
    .line 543
    .line 544
    invoke-interface {p0, p1, p2}, Landroid/support/v4/media/session/b;->P(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    .line 563
    .line 564
    invoke-interface {p0, p1, p2}, Landroid/support/v4/media/session/b;->O(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    .line 592
    invoke-interface {p0, p1, p4, p2}, Landroid/support/v4/media/session/b;->e0(IILjava/lang/String;)V
    ...
    .line 612
    invoke-interface {p0, p1, p4, p2}, Landroid/support/v4/media/session/b;->p0(IILjava/lang/String;)V
    ...
    .line 620
    :pswitch_29
    invoke-interface {p0}, Landroid/support/v4/media/session/b;->t0()Landroid/support/v4/media/session/ParcelableVolumeInfo;
    ...
    .line 655
    :pswitch_2c
    invoke-interface {p0}, Landroid/support/v4/media/session/b;->i()Ljava/lang/String;
    ...
    .line 692
    invoke-static {p1}, Landroid/support/v4/media/session/a$a;->b0(Landroid/os/IBinder;)Landroid/support/v4/media/session/a;
    ...
    .line 696
    invoke-interface {p0, p1}, Landroid/support/v4/media/session/b;->o3(Landroid/support/v4/media/session/a;)V
    ...
    .line 711
    invoke-interface {p0, p1}, Landroid/support/v4/media/session/b;->G2(Landroid/support/v4/media/session/a;)V
    ...
    .line 725
    .line 726
    invoke-interface {p0, p1}, Landroid/support/v4/media/session/b;->R(Landroid/view/KeyEvent;)Z
    ...
    .line 756
    .line 757
    invoke-interface {p0, p1, p4, p2}, Landroid/support/v4/media/session/b;->X1(Ljava/lang/String;Landroid/os/Bundle;Landroid/support/v4/media/session/MediaSessionCompat$ResultReceiverWrapper;)V
