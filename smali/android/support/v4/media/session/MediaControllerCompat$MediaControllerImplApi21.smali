...
.method public constructor <init>(Landroid/content/Context;Landroid/support/v4/media/session/MediaSessionCompat$Token;)V
    ...
    .line 45
    .line 46
    invoke-virtual {p0}, Landroid/support/v4/media/session/MediaControllerCompat$MediaControllerImplApi21;->h()V
...
.method public final c(Landroid/support/v4/media/session/MediaControllerCompat$a;)V
    ...
    .line 38
    invoke-interface {p1, v1}, Landroid/support/v4/media/session/b;->o3(Landroid/support/v4/media/session/a;)V
    :try_end_1
...
.method public final e(Landroid/support/v4/media/session/MediaControllerCompat$a;Landroid/os/Handler;)V
    ...
    .line 38
    invoke-interface {v2, v0}, Landroid/support/v4/media/session/b;->G2(Landroid/support/v4/media/session/a;)V
...
.method public f()Landroid/support/v4/media/session/PlaybackStateCompat;
    ...
    .line 15
    invoke-interface {v0}, Landroid/support/v4/media/session/b;->f()Landroid/support/v4/media/session/PlaybackStateCompat;
...
.method public g()V
    ...
    .line 46
    invoke-interface {v3, v2}, Landroid/support/v4/media/session/b;->G2(Landroid/support/v4/media/session/a;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public final h()V
    ...
    .line 9
    invoke-virtual {p0, v1, v2, v0}, Landroid/support/v4/media/session/MediaControllerCompat$MediaControllerImplApi21;->i(Ljava/lang/String;Landroid/os/Bundle;Landroid/os/ResultReceiver;)V
