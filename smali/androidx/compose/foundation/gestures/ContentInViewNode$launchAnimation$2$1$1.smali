...
# direct methods
.method public constructor <init>(Landroidx/compose/foundation/gestures/ContentInViewNode;Landroidx/compose/foundation/gestures/UpdatableAnimationState;Lkotlinx/coroutines/v0;Landroidx/compose/foundation/gestures/u;)V
    .locals 0
    ...
    iput-object p3, p0, Landroidx/compose/foundation/gestures/ContentInViewNode$launchAnimation$2$1$1;->$animationJob:Lkotlinx/coroutines/v0;

    iput-object p4, p0, Landroidx/compose/foundation/gestures/ContentInViewNode$launchAnimation$2$1$1;->$$this$scroll:Landroidx/compose/foundation/gestures/u;
...
.method public final invoke(F)V
    ...
    invoke-static {v0}, Landroidx/compose/foundation/gestures/ContentInViewNode;->B2(Landroidx/compose/foundation/gestures/ContentInViewNode;)Z
    ...
    invoke-static {v2}, Landroidx/compose/foundation/gestures/ContentInViewNode;->C2(Landroidx/compose/foundation/gestures/ContentInViewNode;)Landroidx/compose/foundation/gestures/ScrollingLogic;

    move-result-object v2

    iget-object v3, p0, Landroidx/compose/foundation/gestures/ContentInViewNode$launchAnimation$2$1$1;->$$this$scroll:Landroidx/compose/foundation/gestures/u;
    ...
    .line 5
    sget-object v1, Landroidx/compose/ui/input/nestedscroll/d;->b:Landroidx/compose/ui/input/nestedscroll/d$a;

    invoke-virtual {v1}, Landroidx/compose/ui/input/nestedscroll/d$a;->b()I

    move-result v1

    .line 6
    invoke-interface {v3, v4, v5, v1}, Landroidx/compose/foundation/gestures/u;->b(JI)J
    ...
    .line 10
    iget-object v1, p0, Landroidx/compose/foundation/gestures/ContentInViewNode$launchAnimation$2$1$1;->$animationJob:Lkotlinx/coroutines/v0;
    ...
    .line 14
    invoke-static {v1, p1, v2, v0, v2}, Lkotlinx/coroutines/x0;->f(Lkotlinx/coroutines/v0;Ljava/lang/String;Ljava/lang/Throwable;ILjava/lang/Object;)V
