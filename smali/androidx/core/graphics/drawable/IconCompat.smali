...
.method public static i(Landroid/graphics/drawable/Icon;)Landroidx/core/graphics/drawable/IconCompat;
    .locals 2
...
.method public static j(Landroid/graphics/Bitmap;Z)Landroid/graphics/Bitmap;
    .locals 9
...
.method public static m(Landroid/graphics/Bitmap;)Landroidx/core/graphics/drawable/IconCompat;
    .locals 2
...
.method public static n(Landroid/net/Uri;)Landroidx/core/graphics/drawable/IconCompat;
    .locals 0
    ...
    .line 8
    invoke-static {p0}, Landroidx/core/graphics/drawable/IconCompat;->o(Ljava/lang/String;)Landroidx/core/graphics/drawable/IconCompat;
...
.method public static o(Ljava/lang/String;)Landroidx/core/graphics/drawable/IconCompat;
    .locals 2
...
.method public static p(Landroid/content/Context;I)Landroidx/core/graphics/drawable/IconCompat;
    .locals 1
    ...
    .line 12
    invoke-static {v0, p0, p1}, Landroidx/core/graphics/drawable/IconCompat;->q(Landroid/content/res/Resources;Ljava/lang/String;I)Landroidx/core/graphics/drawable/IconCompat;
...
.method public static q(Landroid/content/res/Resources;Ljava/lang/String;I)Landroidx/core/graphics/drawable/IconCompat;
    .locals 2
...
.method public static u(Landroid/content/Context;Ljava/lang/String;)Landroid/content/res/Resources;
    .locals 3
...
.method public D()Landroid/graphics/drawable/Icon;
    ...
    .line 2
    invoke-virtual {p0, v0}, Landroidx/core/graphics/drawable/IconCompat;->E(Landroid/content/Context;)Landroid/graphics/drawable/Icon;
...
.method public E(Landroid/content/Context;)Landroid/graphics/drawable/Icon;
    .locals 2
...
.method public e(Landroid/content/Context;)V
    ...
    .line 66
    :cond_1
    invoke-virtual {p0}, Landroidx/core/graphics/drawable/IconCompat;->t()Ljava/lang/String;
    ...
    .line 70
    invoke-static {p1, v2}, Landroidx/core/graphics/drawable/IconCompat;->u(Landroid/content/Context;Ljava/lang/String;)Landroid/content/res/Resources;
...
.method public r()Landroid/graphics/Bitmap;
    ...
    .line 37
    .line 38
    invoke-static {v0, v1}, Landroidx/core/graphics/drawable/IconCompat;->j(Landroid/graphics/Bitmap;Z)Landroid/graphics/Bitmap;
...
.method public toString()Ljava/lang/String;
    ...
    .line 21
    .line 22
    invoke-static {v1}, Landroidx/core/graphics/drawable/IconCompat;->F(I)Ljava/lang/String;
    ...
    .line 85
    .line 86
    invoke-virtual {p0}, Landroidx/core/graphics/drawable/IconCompat;->s()I
...
.method public x(Landroid/content/Context;)Ljava/io/InputStream;
    .locals 4

    .line 1
    invoke-virtual {p0}, Landroidx/core/graphics/drawable/IconCompat;->w()Landroid/net/Uri;
...
.method public y(Landroid/content/Context;)Landroid/graphics/drawable/Drawable;
    ...
    .line 19
    :cond_0
    invoke-virtual {p0, p1}, Landroidx/core/graphics/drawable/IconCompat;->z(Landroid/content/Context;)Landroid/graphics/drawable/Drawable;
...
.method public final z(Landroid/content/Context;)Landroid/graphics/drawable/Drawable;
    .locals 5
    ...
    .line 10
    :pswitch_0
    invoke-virtual {p0, p1}, Landroidx/core/graphics/drawable/IconCompat;->x(Landroid/content/Context;)Ljava/io/InputStream;
    ...
    .line 67
    .line 68
    invoke-static {v2, v1}, Landroidx/core/graphics/drawable/IconCompat;->j(Landroid/graphics/Bitmap;Z)Landroid/graphics/Bitmap;
    ...
    .line 132
    :cond_1
    invoke-static {p1, v0}, Landroidx/core/graphics/drawable/IconCompat;->u(Landroid/content/Context;Ljava/lang/String;)Landroid/content/res/Resources;
    ...
    .line 142
    invoke-static {v0, v3, p1}, LB0/h;->f(Landroid/content/res/Resources;ILandroid/content/res/Resources$Theme;)Landroid/graphics/drawable/Drawable;
