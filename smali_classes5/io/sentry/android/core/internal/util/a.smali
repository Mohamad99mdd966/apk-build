...
.method public constructor <init>(Landroid/content/Context;Lio/sentry/M;Lio/sentry/android/core/P;)V
    ...
    .line 5
    .line 6
    iput-object p2, p0, Lio/sentry/android/core/internal/util/a;->b:Lio/sentry/M;

    .line 7
    .line 8
    iput-object p3, p0, Lio/sentry/android/core/internal/util/a;->c:Lio/sentry/android/core/P;
...
.method public static e(Landroid/content/Context;Landroid/net/ConnectivityManager;Lio/sentry/M;)Lio/sentry/IConnectionStatusProvider$ConnectionStatus;
    .locals 1
    ...
    .line 15
    .line 16
    invoke-interface {p2, p0, p1, v0}, Lio/sentry/M;->c(Lio/sentry/SentryLevel;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    .line 57
    .line 58
    invoke-interface {p2, p1, v0, p0}, Lio/sentry/M;->b(Lio/sentry/SentryLevel;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public static f(Landroid/content/Context;Lio/sentry/M;Lio/sentry/android/core/P;)Ljava/lang/String;
    .locals 4

    .line 1
    invoke-static {p0, p1}, Lio/sentry/android/core/internal/util/a;->h(Landroid/content/Context;Lio/sentry/M;)Landroid/net/ConnectivityManager;
...
.method public static g(Landroid/net/NetworkCapabilities;Lio/sentry/android/core/P;)Ljava/lang/String;
    .locals 2
...
.method public static h(Landroid/content/Context;Lio/sentry/M;)Landroid/net/ConnectivityManager;
    .locals 3
...
.method public static i(Landroid/content/Context;Lio/sentry/M;Lio/sentry/android/core/P;Landroid/net/ConnectivityManager$NetworkCallback;)Z
    .locals 2
    ...
    .line 15
    .line 16
    invoke-interface {p1, p0, p2, p3}, Lio/sentry/M;->c(Lio/sentry/SentryLevel;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    :cond_2
    :try_start_0
    invoke-static {p2, p3}, Landroidx/work/impl/constraints/f;->a(Landroid/net/ConnectivityManager;Landroid/net/ConnectivityManager$NetworkCallback;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    .line 54
    .line 55
    invoke-interface {p1, p2, p3, p0}, Lio/sentry/M;->b(Lio/sentry/SentryLevel;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public static j(Landroid/content/Context;Lio/sentry/M;Lio/sentry/android/core/P;Landroid/net/ConnectivityManager$NetworkCallback;)V
    .locals 1
...
.method public a()Ljava/lang/String;
    ...
    .line 2
    .line 3
    iget-object v1, p0, Lio/sentry/android/core/internal/util/a;->b:Lio/sentry/M;

    .line 4
    .line 5
    iget-object v2, p0, Lio/sentry/android/core/internal/util/a;->c:Lio/sentry/android/core/P;

    .line 6
    .line 7
    invoke-static {v0, v1, v2}, Lio/sentry/android/core/internal/util/a;->f(Landroid/content/Context;Lio/sentry/M;Lio/sentry/android/core/P;)Ljava/lang/String;
...
.method public b()Lio/sentry/IConnectionStatusProvider$ConnectionStatus;
    ...
    .line 4
    .line 5
    invoke-static {v0, v1}, Lio/sentry/android/core/internal/util/a;->h(Landroid/content/Context;Lio/sentry/M;)Landroid/net/ConnectivityManager;
    ...
    .line 15
    .line 16
    iget-object v2, p0, Lio/sentry/android/core/internal/util/a;->b:Lio/sentry/M;

    .line 17
    .line 18
    invoke-static {v1, v0, v2}, Lio/sentry/android/core/internal/util/a;->e(Landroid/content/Context;Landroid/net/ConnectivityManager;Lio/sentry/M;)Lio/sentry/IConnectionStatusProvider$ConnectionStatus;
...
.method public c(Lio/sentry/IConnectionStatusProvider$a;)Z
    .locals 4

    .line 1
    iget-object v0, p0, Lio/sentry/android/core/internal/util/a;->c:Lio/sentry/android/core/P;
    ...
    .line 10
    .line 11
    iget-object p1, p0, Lio/sentry/android/core/internal/util/a;->b:Lio/sentry/M;
    ...
    .line 19
    .line 20
    invoke-interface {p1, v0, v1, v3}, Lio/sentry/M;->c(Lio/sentry/SentryLevel;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    .line 25
    .line 26
    invoke-direct {v0, p0, p1}, Lio/sentry/android/core/internal/util/a$a;-><init>(Lio/sentry/android/core/internal/util/a;Lio/sentry/IConnectionStatusProvider$a;)V
    ...
    .line 39
    .line 40
    invoke-static {p1, v1, v2, v0}, Lio/sentry/android/core/internal/util/a;->i(Landroid/content/Context;Lio/sentry/M;Lio/sentry/android/core/P;Landroid/net/ConnectivityManager$NetworkCallback;)Z
...
.method public d(Lio/sentry/IConnectionStatusProvider$a;)V
    .locals 3
    ...
    .line 16
    .line 17
    invoke-static {v0, v1, v2, p1}, Lio/sentry/android/core/internal/util/a;->j(Landroid/content/Context;Lio/sentry/M;Lio/sentry/android/core/P;Landroid/net/ConnectivityManager$NetworkCallback;)V
