...
.field public final b:Lio/sentry/U1;

.field public final c:Lio/sentry/E1;

.field public volatile d:Lio/sentry/C;
...
.method public constructor <init>(Lio/sentry/SentryOptions;)V
    ...
    .line 2
    iput-object v0, p0, Lio/sentry/m0;->d:Lio/sentry/C;
    ...
    iput-object p1, p0, Lio/sentry/m0;->a:Lio/sentry/SentryOptions;

    .line 4
    new-instance v0, Lio/sentry/T1;

    invoke-direct {v0, p1}, Lio/sentry/T1;-><init>(Lio/sentry/SentryOptions;)V

    .line 5
    new-instance v1, Lio/sentry/E1;

    invoke-direct {v1, v0}, Lio/sentry/E1;-><init>(Lio/sentry/T1;)V

    iput-object v1, p0, Lio/sentry/m0;->c:Lio/sentry/E1;

    .line 6
    new-instance v1, Lio/sentry/U1;

    invoke-direct {v1, v0, p1}, Lio/sentry/U1;-><init>(Lio/sentry/T1;Lio/sentry/SentryOptions;)V

    iput-object v1, p0, Lio/sentry/m0;->b:Lio/sentry/U1;

    return-void
.end method

.method public constructor <init>(Lio/sentry/SentryOptions;Lio/sentry/U1;Lio/sentry/E1;)V
    .locals 1
    ...
    iput-object p1, p0, Lio/sentry/m0;->b:Lio/sentry/U1;
    ...
    iput-object p1, p0, Lio/sentry/m0;->c:Lio/sentry/E1;

    return-void
.end method

.method private h(Lio/sentry/d1;)V
    .locals 1
...
.method private k(Lio/sentry/d1;)V
    .locals 5
    ...
    .line 5
    .line 6
    iget-object v1, p0, Lio/sentry/m0;->a:Lio/sentry/SentryOptions;
    ...
    .line 20
    .line 21
    invoke-virtual {v1, v2}, Lio/sentry/protocol/c;->k(Ljava/lang/String;)V

    .line 22
    .line 23
    .line 24
    iget-object v2, p0, Lio/sentry/m0;->a:Lio/sentry/SentryOptions;
    ...
    .line 30
    invoke-virtual {v1, v2}, Lio/sentry/protocol/c;->m(Ljava/lang/String;)V
    ...
    .line 67
    .line 68
    invoke-virtual {v3, v2}, Lio/sentry/protocol/c;->j(Ljava/lang/String;)V
    ...
    .line 109
    :goto_1
    invoke-virtual {p1, v1}, Lio/sentry/d1;->S(Lio/sentry/protocol/d;)V
...
.method private l(Lio/sentry/d1;)V
    ...
    .line 6
    .line 7
    iget-object v0, p0, Lio/sentry/m0;->a:Lio/sentry/SentryOptions;
...
.method private m(Lio/sentry/d1;)V
    .locals 1
...
.method private u(Lio/sentry/d1;)V
    .locals 1
...
.method private v(Lio/sentry/d1;)V
    .locals 1
...
.method private w(Lio/sentry/d1;)V
    .locals 1
    ...
    .line 8
    .line 9
    invoke-virtual {v0}, Lio/sentry/SentryOptions;->getSdkVersion()Lio/sentry/protocol/n;
...
# virtual methods
.method public final A(Lio/sentry/D1;Lio/sentry/z;)V
    .locals 5
    ...
    .line 6
    .line 7
    invoke-virtual {p1}, Lio/sentry/D1;->o0()Ljava/util/List;
    ...
    .line 96
    :cond_4
    invoke-virtual {p0, p2}, Lio/sentry/m0;->g(Lio/sentry/z;)Z
    ...
    .line 101
    .line 102
    iget-object p2, p0, Lio/sentry/m0;->b:Lio/sentry/U1;

    .line 103
    .line 104
    invoke-virtual {p2}, Lio/sentry/U1;->a()Ljava/util/List;
    ...
    .line 108
    invoke-virtual {p1, p2}, Lio/sentry/D1;->C0(Ljava/util/List;)V
    ...
    .line 128
    :goto_2
    iget-object v0, p0, Lio/sentry/m0;->b:Lio/sentry/U1;

    .line 129
    .line 130
    invoke-virtual {v0, v1, p2}, Lio/sentry/U1;->b(Ljava/util/List;Z)Ljava/util/List;
...
.method public final C(Lio/sentry/d1;Lio/sentry/z;)Z
    .locals 3
    ...
    .line 9
    :cond_0
    iget-object p2, p0, Lio/sentry/m0;->a:Lio/sentry/SentryOptions;
...
.method public a(Lio/sentry/D1;Lio/sentry/z;)Lio/sentry/D1;
    ...
    .line 1
    invoke-virtual {p0, p1}, Lio/sentry/m0;->j(Lio/sentry/d1;)V

    .line 2
    .line 3
    .line 4
    invoke-virtual {p0, p1}, Lio/sentry/m0;->q(Lio/sentry/D1;)V

    .line 5
    .line 6
    .line 7
    invoke-direct {p0, p1}, Lio/sentry/m0;->k(Lio/sentry/d1;)V

    .line 8
    .line 9
    .line 10
    invoke-virtual {p0, p1}, Lio/sentry/m0;->s(Lio/sentry/D1;)V

    .line 11
    .line 12
    .line 13
    invoke-virtual {p0, p1, p2}, Lio/sentry/m0;->C(Lio/sentry/d1;Lio/sentry/z;)Z
    ...
    .line 18
    .line 19
    invoke-virtual {p0, p1}, Lio/sentry/m0;->i(Lio/sentry/d1;)V

    .line 20
    .line 21
    .line 22
    invoke-virtual {p0, p1, p2}, Lio/sentry/m0;->A(Lio/sentry/D1;Lio/sentry/z;)V
...
.method public final c()V
    ...
    .line 1
    iget-object v0, p0, Lio/sentry/m0;->d:Lio/sentry/C;
    ...
    .line 9
    .line 10
    invoke-static {}, Lio/sentry/C;->e()Lio/sentry/C;
...
.method public final g(Lio/sentry/z;)Z
    .locals 1
    ...
    .line 2
    .line 3
    invoke-static {p1, v0}, Lio/sentry/util/j;->h(Lio/sentry/z;Ljava/lang/Class;)Z
...
.method public final i(Lio/sentry/d1;)V
    ...
    .line 1
    invoke-direct {p0, p1}, Lio/sentry/m0;->v(Lio/sentry/d1;)V

    .line 2
    .line 3
    .line 4
    invoke-direct {p0, p1}, Lio/sentry/m0;->m(Lio/sentry/d1;)V

    .line 5
    .line 6
    .line 7
    invoke-virtual {p0, p1}, Lio/sentry/m0;->x(Lio/sentry/d1;)V

    .line 8
    .line 9
    .line 10
    invoke-direct {p0, p1}, Lio/sentry/m0;->l(Lio/sentry/d1;)V

    .line 11
    .line 12
    .line 13
    invoke-direct {p0, p1}, Lio/sentry/m0;->w(Lio/sentry/d1;)V

    .line 14
    .line 15
    .line 16
    invoke-virtual {p0, p1}, Lio/sentry/m0;->z(Lio/sentry/d1;)V

    .line 17
    .line 18
    .line 19
    invoke-direct {p0, p1}, Lio/sentry/m0;->h(Lio/sentry/d1;)V
...
.method public final j(Lio/sentry/d1;)V
    .locals 0

    .line 1
    invoke-direct {p0, p1}, Lio/sentry/m0;->u(Lio/sentry/d1;)V
...
.method public final q(Lio/sentry/D1;)V
    ...
    .line 1
    invoke-virtual {p1}, Lio/sentry/d1;->P()Ljava/lang/Throwable;
    ...
    .line 6
    .line 7
    iget-object v1, p0, Lio/sentry/m0;->c:Lio/sentry/E1;

    .line 8
    .line 9
    invoke-virtual {v1, v0}, Lio/sentry/E1;->c(Ljava/lang/Throwable;)Ljava/util/List;
    ...
    .line 13
    invoke-virtual {p1, v0}, Lio/sentry/D1;->x0(Ljava/util/List;)V
...
.method public final s(Lio/sentry/D1;)V
    ...
    .line 14
    :cond_0
    invoke-virtual {p1}, Lio/sentry/D1;->r0()Ljava/util/Map;
    ...
    .line 19
    .line 20
    invoke-virtual {p1, v0}, Lio/sentry/D1;->B0(Ljava/util/Map;)V
...
.method public final x(Lio/sentry/d1;)V
    ...
    .line 1
    invoke-virtual {p1}, Lio/sentry/d1;->M()Ljava/lang/String;
    ...
    .line 13
    invoke-virtual {p1, v0}, Lio/sentry/d1;->b0(Ljava/lang/String;)V
    ...
    .line 38
    .line 39
    invoke-virtual {v0}, Lio/sentry/C;->d()Ljava/lang/String;
