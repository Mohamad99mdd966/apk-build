...
.method public static synthetic a(Lcom/huawei/hms/framework/network/grs/g/c;Ljava/util/concurrent/ExecutorService;Ljava/lang/String;Lcom/huawei/hms/framework/network/grs/e/c;)Lcom/huawei/hms/framework/network/grs/g/d;
    .locals 0
...
.method private a(Ljava/util/concurrent/ExecutorService;Ljava/util/List;Ljava/lang/String;Lcom/huawei/hms/framework/network/grs/e/c;)Lcom/huawei/hms/framework/network/grs/g/d;
    ...
    new-instance v3, Lcom/huawei/hms/framework/network/grs/g/a;

    iget-object v7, p0, Lcom/huawei/hms/framework/network/grs/g/c;->b:Landroid/content/Context;

    iget-object v9, p0, Lcom/huawei/hms/framework/network/grs/g/c;->a:Lcom/huawei/hms/framework/network/grs/GrsBaseInfo;
    ...
    invoke-direct/range {v3 .. v10}, Lcom/huawei/hms/framework/network/grs/g/a;-><init>(Ljava/lang/String;ILcom/huawei/hms/framework/network/grs/g/c;Landroid/content/Context;Ljava/lang/String;Lcom/huawei/hms/framework/network/grs/GrsBaseInfo;Lcom/huawei/hms/framework/network/grs/e/c;)V

    invoke-virtual {v3}, Lcom/huawei/hms/framework/network/grs/g/a;->g()Ljava/util/concurrent/Callable;
    ...
    iget-object p4, v6, Lcom/huawei/hms/framework/network/grs/g/c;->e:Ljava/util/Map;
    ...
    :try_start_0
    iget-wide v3, v6, Lcom/huawei/hms/framework/network/grs/g/c;->m:J
    ...
    check-cast p3, Lcom/huawei/hms/framework/network/grs/g/d;
    :try_end_0
    ...
    :try_start_1
    invoke-virtual {p3}, Lcom/huawei/hms/framework/network/grs/g/d;->o()Z

    move-result v0

    if-nez v0, :cond_0

    invoke-virtual {p3}, Lcom/huawei/hms/framework/network/grs/g/d;->m()Z
    ...
    const-string v2, "grs request return body is not null and is OK."
    ...
    :catch_6
    :goto_3
    sget-object p3, Lcom/huawei/hms/framework/network/grs/g/c;->n:Ljava/lang/String;

    const-string p4, "the wait timed out"

    invoke-static {p3, p4}, Lcom/huawei/hms/framework/common/Logger;->w(Ljava/lang/String;Ljava/lang/Object;)V
    ...
    invoke-static {p3, v3, v0}, Lcom/huawei/hms/framework/common/Logger;->w(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    const-string v0, "the computation threw an ExecutionException"

    invoke-static {p3, v0, p4}, Lcom/huawei/hms/framework/common/Logger;->w(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    const-string v0, "{requestServer} the computation was cancelled"
    ...
    :goto_8
    invoke-direct {p0, v2}, Lcom/huawei/hms/framework/network/grs/g/c;->b(Lcom/huawei/hms/framework/network/grs/g/d;)Lcom/huawei/hms/framework/network/grs/g/d;
...
.method private b(Ljava/util/concurrent/ExecutorService;Ljava/lang/String;Lcom/huawei/hms/framework/network/grs/e/c;)Lcom/huawei/hms/framework/network/grs/g/d;
    ...
    invoke-static {v5, v3, v7}, Lcom/huawei/hms/framework/common/Logger;->v(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method private b(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v1}, Lcom/huawei/hms/framework/network/grs/GrsBaseInfo;->getAppName()Ljava/lang/String;
...
.method private c()V
    ...
    iget-object v1, p0, Lcom/huawei/hms/framework/network/grs/g/c;->h:Ljava/util/List;
    ...
    const-string v1, "request to GRS server url is{%s} and {%s}"
...
.method public declared-synchronized a(Lcom/huawei/hms/framework/network/grs/g/d;)V
    ...
    invoke-static {v0, v2}, Lcom/huawei/hms/framework/network/grs/f/b;->a(Landroid/content/Context;Lcom/huawei/hms/framework/network/grs/GrsBaseInfo;)V
