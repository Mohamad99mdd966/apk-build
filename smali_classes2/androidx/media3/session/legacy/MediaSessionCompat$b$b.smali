.class public Landroidx/media3/session/legacy/MediaSessionCompat$b$b;
...
# instance fields
.field public final synthetic a:Landroidx/media3/session/legacy/MediaSessionCompat$b;


# direct methods
.method public constructor <init>(Landroidx/media3/session/legacy/MediaSessionCompat$b;)V
    .locals 0
...
# virtual methods
.method public final a(Landroidx/media3/session/legacy/MediaSessionCompat$c;)V
    .locals 1
    ...
    .line 2
    invoke-interface {p1, v0}, Landroidx/media3/session/legacy/MediaSessionCompat$c;->q(Landroidx/media3/session/legacy/f$e;)V
...
.method public final b()Landroidx/media3/session/legacy/MediaSessionCompat$d;
    .locals 3
    ...
    .line 20
    .line 21
    invoke-virtual {v1}, Landroidx/media3/session/legacy/MediaSessionCompat$d;->h()Landroidx/media3/session/legacy/MediaSessionCompat$b;
...
.method public final c(Landroidx/media3/session/legacy/MediaSessionCompat$c;)V
    .locals 3
    ...
    .line 8
    :cond_0
    invoke-interface {p1}, Landroidx/media3/session/legacy/MediaSessionCompat$c;->d()Ljava/lang/String;
    ...
    .line 25
    .line 26
    invoke-interface {p1, v1}, Landroidx/media3/session/legacy/MediaSessionCompat$c;->q(Landroidx/media3/session/legacy/f$e;)V
...
.method public onCommand(Ljava/lang/String;Landroid/os/Bundle;Landroid/os/ResultReceiver;)V
    ...
    .line 1
    invoke-virtual {p0}, Landroidx/media3/session/legacy/MediaSessionCompat$b$b;->b()Landroidx/media3/session/legacy/MediaSessionCompat$d;
    ...
    .line 10
    .line 11
    invoke-virtual {p0, v0}, Landroidx/media3/session/legacy/MediaSessionCompat$b$b;->c(Landroidx/media3/session/legacy/MediaSessionCompat$c;)V
    ...
    .line 29
    .line 30
    invoke-virtual {v0}, Landroidx/media3/session/legacy/MediaSessionCompat$d;->b()Landroidx/media3/session/legacy/MediaSessionCompat$Token;
    ...
    .line 51
    .line 52
    invoke-virtual {p2}, Landroidx/media3/session/legacy/MediaSessionCompat$Token;->e()LY2/c;
    ...
    .line 56
    invoke-static {p1, v1, p2}, LY2/a;->c(Landroid/os/Bundle;Ljava/lang/String;LY2/c;)V
    ...
    .line 84
    .line 85
    invoke-static {p2, p3}, Lu2/a;->a(Landroid/os/Parcelable;Landroid/os/Parcelable$Creator;)Landroid/os/Parcelable;
    ...
    .line 90
    .line 91
    invoke-virtual {p1, p2}, Landroidx/media3/session/legacy/MediaSessionCompat$b;->b(Landroidx/media3/session/legacy/MediaDescriptionCompat;)V
    ...
    .line 115
    .line 116
    invoke-static {p3, v1}, Lu2/a;->a(Landroid/os/Parcelable;Landroid/os/Parcelable$Creator;)Landroid/os/Parcelable;
    ...
    .line 126
    invoke-virtual {p1, p3, p2}, Landroidx/media3/session/legacy/MediaSessionCompat$b;->c(Landroidx/media3/session/legacy/MediaDescriptionCompat;I)V
    ...
    .line 153
    .line 154
    invoke-virtual {p1, p2}, Landroidx/media3/session/legacy/MediaSessionCompat$b;->q(Landroidx/media3/session/legacy/MediaDescriptionCompat;)V
    ...
    .line 165
    .line 166
    iget-object p1, v0, Landroidx/media3/session/legacy/MediaSessionCompat$d;->i:Ljava/util/List;
    ...
    .line 195
    .line 196
    invoke-virtual {v2}, Landroidx/media3/session/legacy/MediaSessionCompat$QueueItem;->c()Landroidx/media3/session/legacy/MediaDescriptionCompat;
    ...
    :cond_8
    :goto_1
    invoke-virtual {p0, v0}, Landroidx/media3/session/legacy/MediaSessionCompat$b$b;->a(Landroidx/media3/session/legacy/MediaSessionCompat$c;)V
...
.method public onCustomAction(Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    .line 252
    .line 253
    invoke-virtual {v1, p1, p2}, Landroidx/media3/session/legacy/MediaSessionCompat$b;->w(Landroidx/media3/session/legacy/RatingCompat;Landroid/os/Bundle;)V
...
.method public onSetRating(Landroid/media/Rating;)V
    ...
    .line 17
    invoke-virtual {v1, p1}, Landroidx/media3/session/legacy/MediaSessionCompat$b;->v(Landroidx/media3/session/legacy/RatingCompat;)V
